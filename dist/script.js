...
const SearchFilter = () => {
  ...
  const [posts, SetPosts] = useState(datatableUsers);
  ...
  useEffect(() => {
    ...
    if (currentPage > 4 && currentPage < numOfButtons.length - 2) {
      // from 5 to 8 -> (10 - 2)
    ...
    if (currentPage > numOfButtons.length - 3) {
      // > 7
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("table", { className: "table table-text-small mb-0" }, /*#__PURE__*/
    React.createElement("thead", { className: "thead-primary table-sorting" }, /*#__PURE__*/
    React.createElement("tr", null, /*#__PURE__*/
    React.createElement("th", null, "#"), /*#__PURE__*/
    React.createElement("th", null, "Name"), /*#__PURE__*/
    React.createElement("th", null, "Position"), /*#__PURE__*/
    React.createElement("th", null, "Gender"), /*#__PURE__*/
    React.createElement("th", null, "Email"), /*#__PURE__*/
    ...
    posts.slice(pageItem.start, pageItem.end).map((data, index) => {
      return /*#__PURE__*/(
        React.createElement("tr", { key: data.id }, /*#__PURE__*/
        React.createElement("td", null, data.id), /*#__PURE__*/
        React.createElement("td", null, data.name), /*#__PURE__*/
        React.createElement("td", null, data.position), /*#__PURE__*/
        React.createElement("td", null, data.gender), /*#__PURE__*/
        React.createElement("td", null, data.email), /*#__PURE__*/
        React.createElement("td", null, data.salary)));
    ...
    React.createElement("div", { className: "dt-pagination" }, /*#__PURE__*/
    React.createElement("ul", { className: "dt-pagination-ul" }, /*#__PURE__*/
    React.createElement("li", { className: `dt-item ${currentPage === 1 ? 'disabled' : ''}` }, /*#__PURE__*/React.createElement("a", { className: "dt-link", onClick: prevPageClick }, "Prev")),

    arrOfCurrButtons.map((data, index) => {
      return /*#__PURE__*/(
        React.createElement("li", { key: index, className: `dt-item ${currentPage === data ? 'active' : ''}` }, /*#__PURE__*/React.createElement("a", { className: "dt-link", onClick: () => SetCurrentPage(data) }, data)));

    }), /*#__PURE__*/

    React.createElement("li", { className: `dt-item ${currentPage === numOfButtons.length ? 'disabled' : ''}` }, /*#__PURE__*/React.createElement("a", { className: "dt-link", onClick: nextPageClick }, "Next"))))))))))));
...
ReactDOM.render( /*#__PURE__*/React.createElement(SearchFilter, null), document.getElementById("root"));